 ...
 *   <link rel="shortcut icon" href="img/logo morowali small.png">
 *   <title>CoreUI - Open Source Bootstrap Admin Template</title>
 *
 *   <!-- Icons -->   <link href="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/css/font-awesome.min.css" rel="stylesheet">   <link href="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/css/simple-line-icons.css" rel="stylesheet">
 *
 *   <!-- Main styles for this application -->
 *   <link href="<?php echo base_path() . path_to_theme() . '/'; ?>css/style.css" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <footer class="app-footer">
    ...
    <span>Project Monitoring &copy; 2017 Dinas PUPR Morowali.</span>
    <span class="ml-auto">Powered by <img src="img/logo.svg" height="25" /> React JS + <img src="img/logo.png" height="18" /></span>
  </footer>

  <!-- Bootstrap and necessary plugins -->
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/js/jquery.min.js"></script>
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/js/umd/popper.min.js"></script>
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/js/bootstrap.min.js"></script>
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/js/pace.min.js"></script>

  <!-- Plugins and scripts required by all views -->
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>vendors/js/Chart.min.js"></script>

  <!-- CoreUI main scripts -->

  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>js/app.js"></script>

  <!-- Plugins and scripts required by this views -->

  <!-- Custom scripts required by this view -->
  <script src="<?php echo base_path() . path_to_theme() . '/'; ?>js/views/main.js"></script>
